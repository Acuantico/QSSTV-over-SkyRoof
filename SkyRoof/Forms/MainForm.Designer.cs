namespace SkyRoof
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      SstvDecoderMNU = new ToolStripMenuItem();
      ...
      // GroupViewPanelMNU
      // 
      GroupViewPanelMNU.DropDownItems.AddRange(new ToolStripItem[] { GroupViewMNU, SatelliteDetailsMNU, TransmittersMNU, SatellitePassesMNU, WaterfallMNU, SstvDecoderMNU, TimelineMNU, SkyViewMNU, EarthViewMNU, QsoEntryMNU, toolStripMenuItem4, ResetWindowLayoutMNU });
      ...
      // SstvDecoderMNU
      // 
      SstvDecoderMNU.Name = "SstvDecoderMNU";
      SstvDecoderMNU.Size = new Size(194, 22);
      SstvDecoderMNU.Text = "SSTV Decoder";
      SstvDecoderMNU.Click += SstvDecoderMNU_Click;
      // 
      // TimelineMNU
      // 
    ...
    public ToolStripMenuItem SstvDecoderMNU;
